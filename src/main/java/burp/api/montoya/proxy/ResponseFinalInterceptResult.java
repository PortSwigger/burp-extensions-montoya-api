 ...
 * {@link ProxyHttpResponseHandler#handleResponseToReturn(InterceptedHttpResponse, HttpRequest, MessageAnnotations)}.
 */
public interface ResponseFinalInterceptResult
{
    ...
    {
        return from(response, MessageAnnotations.NONE, CONTINUE);
    }
     ...
     * to forward the response.
     */
    static ResponseFinalInterceptResult continueWith(HttpResponse response, MessageAnnotations annotations)
    {
        return from(response, annotations, CONTINUE);
    }
     ...
     */
    static ResponseFinalInterceptResult from(HttpResponse response, MessageAnnotations annotations, FinalInterceptAction action)
    {
        return new ResponseFinalInterceptResult()
        {
            @Override
