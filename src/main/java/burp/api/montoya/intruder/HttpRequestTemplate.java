...
public interface HttpRequestTemplate
{
     ...
     */
    static HttpRequestTemplate from(HttpRequest request, List<Range> insertionPointOffsets)
    {
        return from(request.asBytes(), insertionPointOffsets);
    }
     ...
     * @return A new instance of {@link HttpRequestTemplate}.
     */
    static HttpRequestTemplate from(byte[] content, List<Range> insertionPointOffsets)
    {
