...
package net.portswigger.burp.extender.multi;
...
public class MultiApiExample implements BurpExtension, IBurpExtender
{
    ...
    public void initialize(MontoyaApi api)
    {
        ...
        api.misc().setExtensionName("Montoya Name"); //Replaces name set by old Api.
        ...
        {
            api.misc().unloadExtension(); //Should never happen
        }
    }
